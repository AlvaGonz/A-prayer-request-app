...
```javascript
// ❌ Blocks main thread
<script src="https://third-party.com/heavy.js"></script>

// ✅ Async loading
<script src="https://third-party.com/heavy.js" async></script>

// ✅ Delay until interaction
<button onClick="loadWidget()">Open Chat</button>
<script>
  function loadWidget() {
    import('https://third-party.com/widget.js');
  }
</script>
```
...
### Facade pattern
```html
<!-- Load heavy video embed on click -->
<div class="video-facade" onclick="loadVideo(this)">
  <img src="/video-thumbnail.jpg" alt="Play video">
  <button>▶ Play</button>
</div>
